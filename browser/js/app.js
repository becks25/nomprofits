'use strict';
window.app = angular.module('NomprofitsApp', ['ui.router', 'ui.bootstrap', 'fsaPreBuilt', 'js-data', 'ngAnimate']);
...
app.run(function(UserFactory, PartnersFactory, ChefsFactory, EventsFactory) {

      UserFactory.findAll();
      PartnersFactory.findAll();
      ChefsFactory.findAll();
      EventsFactory.findAll();
